...
- Repository URL / local path: https://github.com/JWebMP/AgCharts-Enterprise.git
- Org and project name: JWebMP / Ag Charts Enterprise
- Short description: A plugin library for JWebMP extending the AgCharts plugin with all the enterprise features
