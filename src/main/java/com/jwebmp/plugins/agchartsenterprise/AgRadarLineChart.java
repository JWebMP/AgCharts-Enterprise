...
/**
 * Radar Line Chart builder for AG Charts Enterprise.
 *
 * <p>
 * Builds a radar/spider chart with line visualization connecting data points
 * around a central circle. Ideal for multivariate data comparisons across
 * dimensions with emphasis on line-based patterns.
 * </p>
 *
 * <p>
 * Example usage:
 * <pre>{@code
 * Uni<AgChartOptions<?>> chartOptions = new AgRadarLineChart("chart-id")
...
public class AgRadarLineChart<J extends AgRadarLineChart<J>> extends AgChart<J>
{
     ...
     */
    public AgRadarLineChart(String id)
    {
        super(id);
    }
    ...
    /**
     * Sets the visibility state of the radar line series.
     *
    ...
    public Uni<AgChartOptions<?>> getInitialOptions(com.jwebmp.core.base.ajax.AjaxCall<?> call, com.jwebmp.core.base.ajax.AjaxResponse<?> response)
    {
        return Uni.createFrom().item(() -> {
            // Build radar line series with configured properties
