...
/**
 * Radar Area Series options for AG Charts Enterprise.
 *
 * <p>
 * The Radar Area series visualizes multivariate data on a polar/radar plot
 * with filled areas connecting the data points. Useful for comparing multiple
 * attributes or performance metrics across dimensions with visual area emphasis.
 * </p>
 *
 * <p>
 * Key properties:
 ...
 *   <li><strong>fill</strong> - Area fill color with opacity support</li>
 * </ul>
 * </p>
 *
...
public class AgRadarAreaSeriesOptions<J extends AgRadarAreaSeriesOptions<J>> extends AgSeriesBaseOptions<J>
{
    // --- Required keys ---
    ...
    public AgRadarAreaSeriesOptions()
    {
        setType("radar-area");
    }
    ...
    /**
     * Gets the click detection range for radar areas.
     *
    ...
    /**
     * Gets the fill color for the radar area.
     *
    ...
    /**
     * Gets the fill opacity for the radar area.
     *
    ...
    /**
     * Gets the fill color for radar area markers/points.
     *
     * @return the hex color code or CSS color name, or null for default
     */
    ...
    /**
     * Gets the stroke color for radar area marker outlines.
     *
     * @return the hex color code or CSS color name, or null for default
     */
    ...
    /**
     * Gets the size of radar area markers/points.
     *
