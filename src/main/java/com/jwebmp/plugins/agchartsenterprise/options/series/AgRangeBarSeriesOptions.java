...
/**
 * Range Bar Series options for AG Charts Enterprise.
 *
 * <p>
 * The Range Bar series visualizes data as horizontal bars representing a range
 * between minimum and maximum values. Useful for displaying confidence intervals,
 * price ranges, time windows, or any min-max paired data.
 * </p>
 *
 * <p>
 * Key properties:
 * <ul>
 *   <li><strong>xKey</strong> - Category/label property name</li>
 *   <li><strong>yLowKey</strong> - Lower bound value property name</li>
 *   <li><strong>yHighKey</strong> - Upper bound value property name</li>
 *   <li><strong>fill/stroke</strong> - Bar appearance customization</li>
 * </ul>
 * </p>
 *
...
public class AgRangeBarSeriesOptions<J extends AgRangeBarSeriesOptions<J>> extends AgSeriesBaseOptions<J>
{
    // --- Required keys ---
    private String xKey;      // Category/label property name
    ...
    public AgRangeBarSeriesOptions()
    {
        setType("range-bar");
    }

    /**
     * Gets the property name for category/label values.
     *
    ...
    /**
     * Sets the property name for category/label values.
     *
    ...
    /**
     * Gets the display name for the x (category) field.
     *
    ...
    /**
     * Sets the display name for the x (category) field.
     *
    ...
    /**
     * Gets the click detection range for range bars.
     *
    ...
    /**
     * Gets the corner radius for bar corners.
     *
    ...
    /**
     * Sets the corner radius for bar corners.
     *
    ...
    /**
     * Gets the fill opacity for range bars.
     *
    ...
    /**
     * Sets the fill opacity for range bars.
     *
    ...
    /**
     * Gets the fill color for range bars.
     *
    ...
    /**
     * Sets the fill color for range bars.
     *
    ...
    /**
     * Gets the stroke color for range bars.
     *
     * @return the hex color code or CSS color name, or null for default
     */
    ...
    /**
     * Sets the stroke color for range bars.
     *
    ...
    /**
     * Gets the stroke width for range bars.
     *
    ...
    /**
     * Sets the stroke width for range bars.
     *
    ...
    /**
     * Gets the stroke opacity for range bars.
     *
     * @return the opacity (0..1), or null for default (1)
     */
    ...
    /**
     * Sets the stroke opacity for range bars.
     *
