...
/**
 * Candlestick Series options for AG Charts Enterprise.
 *
 * <p>
 * The Candlestick series visualizes financial data using candlestick charts,
 * showing open, high, low, and close (OHLC) prices for each time period.
 * The visual representation uses a body (from open to close) and wicks (showing
 * high and low prices) to provide comprehensive price action information.
 * </p>
 *
 * <p>
 * Key properties:
 ...
 *   <li><strong>highKey</strong> - Property name for high price (wick top)</li>
 *   <li><strong>lowKey</strong> - Property name for low price (wick bottom)</li>
 *   <li><strong>upColor</strong> - Color when close >= open (bullish candle)</li>
 *   <li><strong>downColor</strong> - Color when close < open (bearish candle)</li>
 * </ul>
 * </p>
 *
...
public class AgCandlestickSeriesOptions<J extends AgCandlestickSeriesOptions<J>> extends AgSeriesBaseOptions<J>
{
    // --- Required keys ---
    ...
    private String highKey;   // High price property name (wick top)
    private String lowKey;    // Low price property name (wick bottom)
    ...
    // --- Colors ---
    private String upColor;    // Bullish candle color (close >= open)
    private String downColor;  // Bearish candle color (close < open)
    ...
    public AgCandlestickSeriesOptions()
    {
        setType("candlestick");
    }
     ...
     * <p>
     * This key identifies which property in the data objects contains
     * the date or time stamp for each candlestick.
     *
     ...
     * <p>
     * The high price determines the top of the candlestick wick.
     *
     ...
     * <p>
     * The low price determines the bottom of the candlestick wick.
     *
     ...
     *
     * @param dateName the name to display in tooltips and legend
     * @return this instance for method chaining
     */
    ...
    /**
     * Gets the color for bullish candlesticks (close >= open).
     *
     ...
     * <p>
     * This color is used when the closing price is greater than or equal
     * to the opening price, typically indicating upward price movement.
     *
    ...
    /**
     * Gets the color for bearish candlesticks (close < open).
     *
     * @return the hex color code or CSS color name, or null for default
     */
     ...
     * <p>
     * This color is used when the closing price is less than the opening price,
     * typically indicating downward price movement.
     *
    ...
    /**
     * Gets the click detection range for candlesticks.
     *
     ...
     * <p>
     * Provide a raw JavaScript function for custom per-item styling.
     *
    ...
    /**
     * Gets the corner radius for candlestick corners.
     *
     * @return the corner radius in pixels, or null for default
     */
    ...
    /**
     * Gets the fill opacity for candlestick bodies.
     *
